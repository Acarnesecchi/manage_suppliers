...
class __TwigTemplate_8f5f98b4b5ce1a73be70908f54d6be12 extends Template
{
    private $source;
    private $macros = [];
...
{% block title %}Add a new supplier{% endblock %}
...
{% block body %}
    ...
    {{ form_start(form) }}
        ...
        <button class=\"btn btn-back\">Save</button>
    {{ form_end(form) }}
{% endblock %}", "supplier/create.html.twig", "/workspaces/php-mariadb/symfony/manage_suppliers/templates/supplier/create.html.twig");
    }
}
