...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/validator.html.twig", "/workspaces/php-mariadb/symfony/manage_suppliers/vendor/symfony/web-profiler-bundle/Resources/views/Collector/validator.html.twig");
    }
}
